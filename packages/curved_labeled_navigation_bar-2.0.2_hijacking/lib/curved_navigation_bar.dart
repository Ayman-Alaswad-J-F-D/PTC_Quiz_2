...
class CurvedNavigationBarState extends State<CurvedNavigationBar>
  ...
  late Color _selectedColorIcon;
  late Color _unSelectedColorIcon;
  ...
  void initState() {
    super.initState();
    _selectedIcon = widget.items[widget.index].selectedIcon;
    _selectedColorIcon = widget.items[widget.index].selcetedIconColor;
    _unSelectedColorIcon = widget.items[widget.index].unSelcetedIconColor;
    ...
    _animationController.addListener(() {
      setState(() {
        ...
        if ((endingPos - _pos).abs() < (_startingPos - _pos).abs()) {
          ...
          _selectedIcon = widget.items[_endingIndex].selectedIcon;
        }
        _buttonHide =
  ...
  String? _getLabel(CurvedNavigationBarItem item) =>
      widget.items.indexOf(item) == widget.index ? null : item.label;
